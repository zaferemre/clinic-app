// src/components/Button/ProfileCreateCompanyButton/ProfileCreateCompanyButton.tsx
...
export default function ProfileCreateCompanyButton({ onCreated }: Props) {
    ...
    const payload: CreateCompanyPayload = {
      ...
      socialLinks:
        instagram || facebook || whatsapp
          ? { instagram, facebook, whatsapp }
          : undefined,
      settings: { allowPublicBooking: true, inactivityThresholdDays: 60 },
    };
  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 bg-brand-main text-white rounded-xl shadow hover:bg-brand-dark transition text-sm flex items-center gap-2"
      >
        <BuildingOffice2Icon className="h-5 w-5" /> Yeni Şirket
      </button>
